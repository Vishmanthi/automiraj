				...
				<div class="w3-col m7" style="border: 1px solid lightgrey;border-radius: 3px;background-color: white;margin-right: 16px">
					...
					<div class="w3-row-padding">
						<div class="w3-col w3-container" style="width: 10%;">
							<label>Title</label>
							<input class="w3-input w3-border w3-round" type="text" name="title" placeholder="">
						</div>
						<div class="w3-col w3-container" style="width: 45%;">
							<label>First Name</label>
							<input class="w3-input w3-border w3-round" type="text" name="fname" placeholder="">
						</div>
						<div class="w3-col w3-container" style="width: 45%;">
							<label>Last Name</label>
							<input class="w3-input w3-border w3-round" type="text" name="lname" placeholder="">
						</div>
					</div>
					<div class="w3-row-padding">
						<div class="w3-col w3-container" style="width: 100%;">
							<label>NIC No</label>
							<input class="w3-input w3-border w3-round w3-disabled" style="background-color: rgba(0,0,0,0.1);" type="text" name="nic" placeholder="">
						</div>						
					</div>
					<div class="w3-row-padding">
						<div class="w3-col w3-container" style="width: 100%;">
							<label>Address</label>
							<input class="w3-input w3-border w3-round" type="text" name="add" placeholder="">
						</div>						
					</div>
					<div class="w3-row-padding">
						<div class="w3-col w3-container" style="width: 50%;">
							<label>Contact Number</label>
							<input class="w3-input w3-border w3-round" type="text" name="cno" placeholder="">
						</div>
						<div class="w3-col w3-container" style="width: 50%;">
							<label>Email</label>
							<input class="w3-input w3-border w3-round" type="text" name="email" placeholder="">
						</div>
