	...
	<div class="w3-top">
	  <div class="w3-bar w3-card w3-black" style="opacity: 0.8">
	    ...
	    <div class="w3-right">
	      ...
	      <a onclick="document.getElementById('login').style.display='block'" class="w3-bar-item w3-button w3-hover-yellow w3-hide-small" style="padding: 13px 16px;width: auto;">LOGOUT</a>
