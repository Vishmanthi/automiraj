	...
	<div class="w3-top">
	  <div class="w3-bar w3-card w3-black" style="opacity: 0.8">
	    ...
	    <div class="w3-right">
	      ...
	      <a href="../welcome/customer#contact" class="w3-bar-item w3-button  w3-hide-small w3-hover-yellow w3-hide-medium" style="padding: 13px 16px;text-decoration: none">SERVICES</a>
	      ...
	      <a href="../users/logout" class="w3-bar-item w3-button w3-hover-yellow w3-hide-small" style="padding: 13px 16px;width: auto;text-decoration: none">LOGOUT</a>
